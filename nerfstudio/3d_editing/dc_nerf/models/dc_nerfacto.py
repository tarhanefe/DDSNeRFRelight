...
import numpy as np
import torch
from dc_nerf.fields.dc_nerfacto_field import DCNerfactoField
...
@dataclass
class DCNerfactoModelConfig(ModelConfig):
    """Nerfacto Model Config"""

    # able to turn off appearance embedding

    _target: Type = field(default_factory=lambda: DCNerfactoModel)
...
class DCNerfactoModel(Model):
    ...
    def get_image_metrics_and_images(
        ...
        images_dict = {"combined": combined_rgb, "img": pred_rgb, "accumulation": combined_acc, "depth": combined_depth}
